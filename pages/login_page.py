...
class LoginPage(BasePage):
    ...
    def should_be_login_url(self):
        assert "login" in self.browser.current_url, "Login text is not presented in url"
    ...
    def register_new_user(self, email, password):
        ...
        self.browser.find_element(*LoginPageLocators.REGISTER_PASSWORD_CONF_FIELD).send_keys(password)
